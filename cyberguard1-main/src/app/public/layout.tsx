    ...
    <>
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 dark:bg-slate-800 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          <Link href="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white text-sm font-bold"><i className="fas fa-shield-halved"></i></div>
      ...
      <footer className="bg-slate-900 text-white mt-20">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4"><i className="fas fa-shield-halved text-blue-400 text-xl"></i><span className="text-lg font-bold">CyberGuard</span></div>
        ...
        <div className="border-t border-slate-800 py-4 text-center text-slate-500 text-sm"><p>© 2024 CyberGuard. All rights reserved.</p></div>
      </footer>
    </>
  );
}